...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image_Stack.tag'
        db.delete_column('computing_image_stack', 'tag')

        # Adding field 'Image_Stack.date_added'
        db.add_column('computing_image_stack', 'date_added', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Image_Stack.tag'
        db.add_column('computing_image_stack', 'tag', self.gf('tagging.fields.TagField')(default=''), keep_default=False)

        # Deleting field 'Image_Stack.date_added'
        db.delete_column('computing_image_stack', 'date_added')
