...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.type_of_image'
        db.alter_column('computing_image', 'type_of_image', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Image.type_of_image'
        db.alter_column('computing_image', 'type_of_image', self.gf('django.db.models.fields.CharField')(max_length=500))
