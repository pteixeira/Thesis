...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Usage'
        db.create_table('computing_usage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['computing.Image_Stack'])),
            ('number_of_uses', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('computing', ['Usage'])


    def backwards(self, orm):
        
        # Deleting model 'Usage'
        db.delete_table('computing_usage')
