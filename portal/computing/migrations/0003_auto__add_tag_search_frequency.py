...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Tag_Search_Frequency'
        db.create_table('computing_tag_search_frequency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('freq', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
        ))
        db.send_create_signal('computing', ['Tag_Search_Frequency'])


    def backwards(self, orm):
        
        # Deleting model 'Tag_Search_Frequency'
        db.delete_table('computing_tag_search_frequency')
